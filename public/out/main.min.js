...
(() => {
  ...
  function n(n) {
    ...
    o.innerHTML = "", a.forEach((t, n) => {
      ...
      l.classList.add("main__span"), a.classList.add("main__item"), i.classList.add("main__img"), r.classList.add("main__link"), i.src = t.album.images[1]?.url || t.album.images[0]?.url || "", i.alt = t.album.name, r.href = t.external_urls.spotify, r.target = "_blank", r.rel = "noopener noreferrer nofollow", r.textContent = `${t.name} - ${t.artists[0].name}`, l.textContent = "click", o.appendChild(a), r.appendChild(l), a.appendChild(i), a.appendChild(r), (t => {
